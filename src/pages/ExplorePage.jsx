...
export default function ExplorePage({ asSection = false }) {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="absolute md:absolute inset-0 md:left-[38%] md:right-0 md:top-0 md:bottom-0 w-full md:w-[62%] h-full md:min-h-full md:bg-black flex flex-col justify-start relative overflow-y-auto overflow-x-hidden px-0 sm:px-6 md:px-0 py-8 sm:py-10 md:pt-8 font-sans z-10"
        style={{ maxWidth: '100%' }}
        initial={{ x: 50, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
